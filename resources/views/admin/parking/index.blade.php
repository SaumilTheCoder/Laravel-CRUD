...
<div class="content-wrapper">
    ...
    <aside class="main-sidebar" style="height: 755px;">
      <!-- sidebar -->
      <div class="sidebar">
        <!-- Sidebar user panel -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
         ...
         <li> <a href="{{asset('admin/dashboard')}}"><i class="icon-home"></i> <span>Dashboard</span> </a>
          ...
          <li> <a href="#"> <i class="icon-note"></i> <span>Users</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
            <ul class="treeview-menu">

              <li><a href="{{asset('admin/add1/create')}}"><i class="fa fa-angle-right"></i> Add</a></li>

              <li><a href="{{asset('admin/add1')}}"><i class="fa fa-angle-right"></i> View</a></li>
            </ul>
          </li>
  ...
  <!-- Parking
   -->
    ...
    <li class="active treeview"> <a href="#"><i class="fas fa-car"></i> <span>Parking</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">

        <li><a href="{{asset('admin/parking/create')}}"><i class="fa fa-angle-right"></i> Add category</a></li>

        <li class="active"><a href="{{asset('admin/parking')}}"><i class="fa fa-angle-right"></i> Manage category</a></li>
      </ul>
    </li>
          ...
          <div class="table-responsive">
              ...
              <thead>
                <tr style="font-size: 14px;">
                    <th>Parking_ID</th>
                    <th>Fourwheeler_total_no</th>
                    <th>Twowheeler_total_no</th>
                    <th>Tempo_total_no  </th>
                    <th>Parking_name  </th>
                    {{-- <th>Image</th> --}}
                <th>Country_id</th>
                <th>State_id</th>
    ...
    <tbody style="font-size: 11px;    line-height: 1.5;">
      <tr>
        <td>
          ...
          <tr>
          <td>{{$row->id}}</td>
          <td>{{$row->fourwheeler}}</td>
          <td>{{$row->twowheeler}}</td>
          <td>{{$row->tempo}}</td>
          <td>{{$row->country}}</td>
          <td>{{$row->state}}</td>
          <td>{{$row->city}}</td>
          ...
          <td>
            ...
            {!!Form::open(['action'=>['admin\Parking@destroy',$row->id],'method'=>'POST'])!!}
