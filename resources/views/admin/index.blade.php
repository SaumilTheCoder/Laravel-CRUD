@extends('admin/layout/projectlayout')
@section('content')
<!DOCTYPE html>
<html>
<head>
...
<div class="bg-img">
  ...
  <form action="{{URL('admin/loginprocess')}}" class="container" method="POST" style="margin: -623px 425px;">
    <h2>Laravel Loginform</h2>
    @csrf
